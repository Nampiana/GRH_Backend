...
public class AuthService {
    ...
    public LoginResponse login(Map<String, String> loginData) {
        ...
        return new LoginResponse(individu.getId() ,token, individu.getNom(), individu.getPrenom(), individu.getAdresse(), individu.getEmail(), individu.getTelephone(), utilisateur.getRoles(), utilisateur.getIdSociete(), utilisateur.getEtat(), utilisateur.getId());
    }
